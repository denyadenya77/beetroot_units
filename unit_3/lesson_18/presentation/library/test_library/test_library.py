...
class TestLibrary(unittest.TestCase):
    ...
    @patch('library.Library.get_person_card')
    @patch('library.Library.register_person')
    @patch('library.Library.is_person_registered')
    ...
    @patch('personcard.PersonCard.take_book')
